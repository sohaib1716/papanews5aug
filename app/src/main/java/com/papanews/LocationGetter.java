...
public class LocationGetter {
    ...
    public LocationGetter(Context mContext, int requestLocation, LocationManager locationManager) {
    ...
    private void getTheAddress(double latitude, double longitude) {
        ...
        try {
            ...
            Log.e("soheb", city+","+state);//
            global.userLoc = city+","+state;//make it global for upload
